 ...
 */
internal object HexGridCalculator {
     ...
     *
     * This function defines lines as collinear cells, not necessarily
     * contiguous ones. Please see the README's Library section for details.
     */
     ...
     * cells, and a [lineCount] number of cross lines. [isMajor] specifies
     * whether the measure is along the hexagon's major or minor axis.
     *
     * This function defines lines as collinear cells, not necessarily
     * contiguous ones. Please see the README's Library section for details.
     */
    ...
    /**
     * Returns the line count for a grid of regular hexagons that have
     * [hexEdge] long edges, constrained by [available] length, with [margin]
    ...
    /**
     * Returns the rectangular size of a hexagon with edge length of [hexEdge],
     * and orientation determined by [isHorizontal].
     */
    ...
    /**
     * Returns the length of a regular hexagon's major axis if its edge has a
     * length of [hexEdge].
     *
    ...
    /**
     * Returns the length of a regular hexagon's minor axis if its edge has a
     * length of [hexEdge].
     *
     * I don't know that you'll ever need this; it's included mainly as info.
     */
